...
SECRET_KEY = os.environ.get('SECRET_KEY', "django-insecure-^c85%r4$o5k$(os)u_#$+mvd00w#kecwzk_hu)qd9yt@#b^!v_")
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'AIBF Camp <noreply@aibf.org.au>')
